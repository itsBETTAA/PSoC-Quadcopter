// ======================================================================
// Base Station.v generated from TopDesign.cysch
// 07/05/2017 at 08:54
...
module top ;
	...
	wire [0:0] tmpOE__butt_pin_net;
	wire [0:0] tmpFB_0__butt_pin_net;
	wire [0:0] tmpIO_0__butt_pin_net;
	electrical [0:0] tmpSIOVREF__butt_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		butt_pin
		 (.oe(tmpOE__butt_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__butt_pin_net[0:0]}),
		  .io({tmpIO_0__butt_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__butt_pin_net),
		  .interrupt({Net_73}),
		  .annotation({Net_74}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__butt_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
