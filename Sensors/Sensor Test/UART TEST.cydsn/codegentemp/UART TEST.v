...
module top ;
    ...
    UART_v2_50_0 debSerial (
        ...
        .rx_data(Net_12),
        .rx_clk(Net_13));
    defparam debSerial.Address1 = 0;
    defparam debSerial.Address2 = 0;
    defparam debSerial.EnIntRXInterrupt = 0;
    defparam debSerial.EnIntTXInterrupt = 0;
    defparam debSerial.FlowControl = 0;
    defparam debSerial.HalfDuplexEn = 0;
    defparam debSerial.HwTXEnSignal = 1;
    defparam debSerial.NumDataBits = 8;
    defparam debSerial.NumStopBits = 1;
    defparam debSerial.ParityType = 0;
    defparam debSerial.RXEnable = 1;
    defparam debSerial.TXEnable = 1;
