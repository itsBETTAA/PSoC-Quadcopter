// ======================================================================
// Base Station_v2.v generated from TopDesign.cysch
// 07/05/2017 at 20:52
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("caaed4c6-eed0-4796-a3fa-3090dc87ad93"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("866f3ac7-7da3-4bbf-923d-00b3ae2b1989"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("954b39cb-c1ce-4b7b-872a-b07228728793"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__GPOUT_net;
	wire [0:0] tmpFB_0__GPOUT_net;
	wire [0:0] tmpIO_0__GPOUT_net;
	electrical [0:0] tmpSIOVREF__GPOUT_net;

	cy_psoc3_pins_v1_10
		#(.id("a33f683e-9baa-40ef-ab73-d21fd4e69325"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		GPOUT
		 (.oe(tmpOE__GPOUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPOUT_net[0:0]}),
		  .io({tmpIO_0__GPOUT_net[0:0]}),
		  .siovref(tmpSIOVREF__GPOUT_net),
		  .interrupt({Net_177}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GPOUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
