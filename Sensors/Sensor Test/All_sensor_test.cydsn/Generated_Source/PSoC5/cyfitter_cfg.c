...
#define BS_UDB_1_3_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000C44u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000CDCu)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000CE8u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000CF0u)
