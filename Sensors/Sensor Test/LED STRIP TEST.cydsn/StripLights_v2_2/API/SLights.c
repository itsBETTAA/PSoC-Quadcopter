...
0x0000FFFF, 0x0055FFFF, 0x00AAFFFF, 0xFFFFFFFF,  // 60, Yellow,??, ??, White
...
extern uint32  `$INSTANCE_NAME`_DimShift;
    ...
    switch(dimLevel)
    {
	   ...
	   case 5:
		   `$INSTANCE_NAME`_DimMask = 0x07070707;
		   `$INSTANCE_NAME`_DimShift = 5;
		   break;

	   case 6:
		   `$INSTANCE_NAME`_DimMask = 0x03030303;
		   `$INSTANCE_NAME`_DimShift = 6;
		   break;

	   case 7:
		   `$INSTANCE_NAME`_DimMask = 0x01010101;
		   `$INSTANCE_NAME`_DimShift = 7;
		   break;
